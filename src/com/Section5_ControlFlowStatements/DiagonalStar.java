...
import javax.swing.*;
    ...
    public class DiagonalStar {
        ...
        public static void printSquareStar (int numbers) {

            int totalRows = numbers;
            ...
            if (totalRows < 5) {
                ...
                for (int row = 1; row <= totalRows; row++) {
                    for (int col = 1; col <= totalRows; col++) {
                        if ((col == 1) || (col == totalRows) || (row == 1) ||
                                (row == totalRows) || (row == col) || (row + col == totalRows + 1)) {
                            System.out.print("*");
                        } else {
                            System.out.print(" ");
                        }
...
The patterns above consist of a number of rows and columns (where number is the number of rows to print). For each row or column, stars are
printed based on four conditions (Read them carefully):
